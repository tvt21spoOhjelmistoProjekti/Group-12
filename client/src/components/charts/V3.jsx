...
const V3 = () => {
    ...
    const getData = async () => {
        try{
            const response = await axios.get(process.env.REACT_APP_REQUEST_URL + "chart/V3")
                ...
                datasets: [
                    {
                        ...
                        data: response.data.map(d => ({ time: new Date(d.Time_Annual + "-01-01" ), value: d.Mean_Annual })),
                        borderColor: "black",
